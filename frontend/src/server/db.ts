...
class Database {
    ...
    const listings: Listing[] = [
      {
        ...
        description: 'Excellent condition iPhone 13 Pro. 88% battery health, original screen, no scratches. Comes with a adapter, charging cable and box. Bought locally, selling due to upgrade. Negotiable.',
        price: 75000,
      ...
      {
        id: 'lst_sofa',
        title: 'L-Shaped Cozy Living Room Sofa',
        description: 'Hardwood base, gray fabric L-shaped sofa. Very comfortable and durable. 6 months old. No stains or tears. Selling since we are moving houses. Location Westlands.',
        price: 45000,
        category: 'Furniture',
      ...
      {
        id: 'lst_avocado',
        title: 'Organic Fuerte Avocados - Box of 20',
        description: 'Freshly harvested giant Hass and Fuerte avocados directly from Meru. Ripe and extremely sweet. Free delivery within 3km of Kilimani or pick up at Kilimani mall.',
        price: 1500,
        category: 'Food & Groceries',
        images: ['https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?auto=format&fit=crop&w=600&q=80'],
        vendorId: 'usr_johndoe',
        vendorName: 'John Kamau',
        vendorVerified: true,
        latitude: NAIROBI_COORDS.KILIMANI.latitude,
      ...
      },
      {
        ...
        description: 'Dual suspension mountain bike. Shimano gear system, front and rear disc brakes. Lightweight aluminum alloy frame. Selling at a bargain since I rarely use it.',
        price: 18000,
      ...
      {
        id: 'lst_dress',
        title: 'Elegant Ankara Dinner Dress',
        description: 'Handmade, high-quality Ankara print dinner dress. Fits Size M (10-12). Styled with a modern sash. Worn once for a wedding. Stunning colors.',
        price: 3500,
      ...
      {
        id: 'lst_microwave',
        title: 'Ramtons Digital Microwave 20L',
        description: 'Ramtons microwave with grill feature. Solves meal preps instantly. Heating elements work perfectly and it is very clean. Only used for 1 year.',
        price: 6500,
        category: 'Electronics',
      ...
      {
        id: 'lst_plumber',
        title: 'Emergency Plumbing & Hot Water Repair',
        description: 'Certified 24/7 master plumber in Westlands. Specialized in pipe bursts, clogged drain clearance, kitchen installations, pressure adjustments, and boiler maintenance. Fast service, friendly rates, and fully equipped tool-box.',
        price: 3500,
      ...
      {
        id: 'lst_electrician',
        title: 'Residential Electrical Installation & Safety Audits',
        description: 'Need socket replacements, cooker wiring, fuse board repairs, or safety checks? Standard electrical installations and troubleshooting services done by an EPRA licensed electrical contractor. Safe and highly standard workmanship.',
        price: 4000,
        category: 'Local Services',
  ...
  // --- Listings API ---
  public async getListings(filters: Partial<{ query: string; category: string; maxDistance: number; latitude: number; longitude: number; sortBy: string }>): Promise<Listing[]> {
    let list: Listing[] = [];
