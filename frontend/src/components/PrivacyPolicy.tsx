      ...
      <header className="sticky top-0 z-40 bg-zinc-950 text-white border-b border-zinc-800">
        <div className="max-w-3xl mx-auto px-5 py-3.5 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-display font-black tracking-tight text-lg">Privacy Policy</h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-7 text-sm text-zinc-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc ml-5 mt-2 space-y-1">
            ...
            <li>Request deletion of your personal data (<Link to="/data-deletion" className="text-emerald-600 underline hover:text-emerald-700">see our Data Deletion page</Link>).</li>
